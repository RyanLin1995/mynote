...
其中，inode table 与 data block 称为数据存放区域，其他如 super block、block bitmap、inode bitmap 等区段称为metadata(中介数据)，因为 super block、inode bitmap、block bitmap 的数据是经常变动的，每次新增、移除、