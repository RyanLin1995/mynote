...
|file system size (Linux)|2,199,023,254,528 (2TiB)^[PS]^|8,796,093,018,112 (8TiB)|17,592,186,036,224 (16TiB)|35,184,372,080,640 (32TiB)|
...
PS: This limit comes from the maximum size of a block device in Linux 2.4; it is unclear whether a Linux 2.6 kernel using a 1KiB block size could properly format and mount a Ext2 partition larger than 2TiB.